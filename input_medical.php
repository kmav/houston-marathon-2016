<?php session_start(); // Starting Session if(!isset($_SESSION[ 'login_user'])){ header( "location: index.php"); } ?>
<!DOCTYPE html>
<html>
...
<body onload="updatePage(); setInterval('updatePage()',1000)">
    ...
    <form action='updateAid.php' class="inputform" method="post" id="inputform">
        ...
        <script type="text/javascript">
            // Gets current time, formats it nicely, and displays in the page
